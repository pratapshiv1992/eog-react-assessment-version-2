...
const Navbar = ({classes})=> {
    return (
        <div className={classes.root}>
            <AppBar position="relative" color="primary" style={{backgroundColor: "cornflowerblue"}}  >
                <Toolbar  >
                    <IconButton onClick={()=>alert('You clicked menu button')} className={classes.menuButton} color="inherit" aria-label="Menu">
                        <MenuIcon />
                    </IconButton>
